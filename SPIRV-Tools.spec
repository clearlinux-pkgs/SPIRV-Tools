...
Source0  : https://github.com/KhronosGroup/SPIRV-Tools/archive/v2024.3/SPIRV-Tools-2024.3.tar.gz
...
Patch1: backport-e99a5c033ea2c933d0403b97db590212fb5a2542.patch
...
%prep
%setup -q -n SPIRV-Tools-2024.3
cd %{_builddir}/SPIRV-Tools-2024.3
%patch -P 1 -p1
pushd ..
cp -a SPIRV-Tools-2024.3 build32
popd
pushd ..
cp -a SPIRV-Tools-2024.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743706992
mkdir -p clr-build
pushd clr-build
