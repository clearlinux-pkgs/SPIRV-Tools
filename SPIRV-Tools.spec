...
Source0  : https://github.com/KhronosGroup/SPIRV-Tools/archive/vulkan-sdk-1.3.290.0/SPIRV-Tools-1.3.290.0.tar.gz
...
%prep
%setup -q -n SPIRV-Tools-vulkan-sdk-1.3.290.0
cd %{_builddir}/SPIRV-Tools-vulkan-sdk-1.3.290.0
pushd ..
cp -a SPIRV-Tools-vulkan-sdk-1.3.290.0 build32
popd
pushd ..
cp -a SPIRV-Tools-vulkan-sdk-1.3.290.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1727460401
mkdir -p clr-build
pushd clr-build
...
export GOAMD64=v2
%cmake .. -DSPIRV-Headers_SOURCE_DIR=/usr \
...
%cmake -DLIB_INSTALL_DIR:PATH=/usr/lib32 -DCMAKE_INSTALL_LIBDIR=/usr/lib32 -DLIB_SUFFIX=32 .. -DSPIRV-Headers_SOURCE_DIR=/usr \
-DSPIRV_TOOLS_BUILD_STATIC=OFF \
-DBUILD_SHARED_LIBS=ON  -G 'Unix Makefiles'
make  %{?_smp_mflags}
...
cp %{_builddir}/SPIRV-Tools-vulkan-sdk-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/SPIRV-Tools/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
cp %{_builddir}/SPIRV-Tools-vulkan-sdk-%{version}/utils/vscode/src/lsp/LICENSE %{buildroot}/usr/share/package-licenses/SPIRV-Tools/2b8b815229aa8a61e483fb4ba0588b8b6c491890 || :
export GOAMD64=v2
pushd ../build32/
pushd clr-build32
%make_install32
...
%defattr(-,root,root,-)
/V3/usr/bin/spirv-as
/V3/usr/bin/spirv-cfg
/V3/usr/bin/spirv-dis
/V3/usr/bin/spirv-link
/V3/usr/bin/spirv-lint
/V3/usr/bin/spirv-objdump
/V3/usr/bin/spirv-opt
/V3/usr/bin/spirv-reduce
/V3/usr/bin/spirv-val
/usr/bin/spirv-as
/usr/bin/spirv-cfg
/usr/bin/spirv-dis
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libSPIRV-Tools-diff.so
/V3/usr/lib64/libSPIRV-Tools-link.so
/V3/usr/lib64/libSPIRV-Tools-lint.so
/V3/usr/lib64/libSPIRV-Tools-opt.so
/V3/usr/lib64/libSPIRV-Tools-reduce.so
/V3/usr/lib64/libSPIRV-Tools-shared.so
/V3/usr/lib64/libSPIRV-Tools.so
