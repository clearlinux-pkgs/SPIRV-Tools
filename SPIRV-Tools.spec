...
Source0  : https://github.com/KhronosGroup/SPIRV-Tools/archive/vulkan-sdk-1.3.275.0/SPIRV-Tools-1.3.275.0.tar.gz
...
%prep
%setup -q -n SPIRV-Tools-vulkan-sdk-1.3.275.0
cd %{_builddir}/SPIRV-Tools-vulkan-sdk-1.3.275.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709142850
mkdir -p clr-build
pushd clr-build
