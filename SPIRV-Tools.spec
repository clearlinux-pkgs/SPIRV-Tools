...
Source0  : https://github.com/KhronosGroup/SPIRV-Tools/archive/v2020.7/SPIRV-Tools-2020.7.tar.gz
...
%prep
%setup -q -n SPIRV-Tools-2020.7
cd %{_builddir}/SPIRV-Tools-2020.7
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614208827
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/SPIRV-Tools-2020.7/LICENSE %{buildroot}/usr/share/package-licenses/SPIRV-Tools/2b8b815229aa8a61e483fb4ba0588b8b6c491890
cp %{_builddir}/SPIRV-Tools-2020.7/utils/vscode/src/lsp/LICENSE %{buildroot}/usr/share/package-licenses/SPIRV-Tools/2b8b815229aa8a61e483fb4ba0588b8b6c491890
pushd clr-build32
%make_install32
