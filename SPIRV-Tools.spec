...
Source0  : https://github.com/KhronosGroup/SPIRV-Tools/archive/v2025.1/SPIRV-Tools-2025.1.tar.gz
...
%prep
%setup -q -n SPIRV-Tools-2025.1
cd %{_builddir}/SPIRV-Tools-2025.1
pushd ..
cp -a SPIRV-Tools-2025.1 build32
popd
pushd ..
cp -a SPIRV-Tools-2025.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746040917
mkdir -p clr-build
pushd clr-build
