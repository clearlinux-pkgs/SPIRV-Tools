...
Version  : 2022.4
Release  : 10
URL      : https://github.com/KhronosGroup/SPIRV-Tools/archive/v2022.4/SPIRV-Tools-2022.4.tar.gz
Source0  : https://github.com/KhronosGroup/SPIRV-Tools/archive/v2022.4/SPIRV-Tools-2022.4.tar.gz
...
%prep
%setup -q -n SPIRV-Tools-2022.4
cd %{_builddir}/SPIRV-Tools-2022.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672163701
mkdir -p clr-build
pushd clr-build
